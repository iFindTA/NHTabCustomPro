...
@protocol NHTabBarControllerDelegate;
@interface NHTabBarController : UIViewController
...
// Tab info array
@property (nonatomic, strong) NSArray *tabItemsInfo;

// Bottom tab bar view
@property (nonatomic, strong) NHTabBarView *tabBar;

// Delegate
@property (nonatomic, assign) id <NHTabBarControllerDelegate> delegate;
...
@protocol NHTabBarControllerDelegate <NSObject>

-(void)tabBarController:(NHTabBarController *)tabbar didSelectViewController:(UIViewController *)viewController;
@end

extern NSString *const kTabItemInfoTitleKey;
extern NSString *const kTabItemInfoNormalImageKey;
extern NSString *const kTabItemInfoSelectImageKey;

extern NSString *const kTabBarItemFontName;
extern NSString *const kTabBarItemIconInfo;
extern NSString *const kTabBarItemTitleInfo;
